...
- **Scales: depth over breadth, and PRACTISED hands together, two octaves.** The key *order*
  follows your Theory course (C→G→D→F→A,B♭,E♭→minors), but how they're practised is your
...
Legend: 🔁 habit · 🎹 scales (self-check) · 👁️ Note Recognition · 🎵 Chord Recognition ·
👂 Ear Training · 🎧 play-by-ear/improv (self-check) · 🎼 piece · 📖 theory.

---

## 1. First Steps  *(absolute beginner)*
- 🔁 Build the habit: clock up your **first 30 days practised** (they never get taken away, even if you miss a day). Consistency matters far more than difficulty right now.
...
- 👁️ Reach **12+** in Note Recognition, so you can find notes without hunting.
...
- 🔁 Reach **100 days practised**. You are becoming someone who practises.
...
- 👁️ Reach **30+** in Note Recognition.
...
## 3. Foundations
- 🔁 Reach **250 days practised** — consistency is now part of who you are.
...
- 👁️ Reach **40+** in Note Recognition.
...
- 👁️ Reach **46+** in Note Recognition (near the ceiling — then maintain).
...
- 👁️👂🎵 Hold your recognition scores near their ceilings (Note ~48, Ear ~30, Chord ~24).
...
|---|---|---|
| 🔁 Days practised | distinct `practice_sessions.session_date` count | total days practised ≥ target (never resets — a missed day costs nothing) |
...
| 👁️ Note Recognition | best `note_game_scores.score` | best ≥ target |
