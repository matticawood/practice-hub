...
(function () {
  ...
  const GOALS = [
    ...
    [ // 2 Beginner
      ...
      { icon: "note",   group: "note",   label: "Score 15 in Note Recognition in each of C, G, D and F major", type: "note", target: 15, match: { keys: ["C", "G", "D", "F"] } },
    ...
    [ // 3 Foundations
      ...
      { icon: "note",   group: "note",   label: "Score 15 in Note Recognition in each of A, B♭ and E♭ major", type: "note", target: 15, match: { keys: ["A", "Bb", "Eb"] } },
