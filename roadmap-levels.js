...
(function () {
  ...
  const GOALS = [
    [ // 1 First Steps
      { icon: "days",   label: "Reach your first 30 days of practice", type: "days", target: 30 },
      { icon: "scales", label: "Play C and G major, hands together, two octaves", type: "self", key: "s1-scales" },
      { icon: "note",   label: "Reach 12 in Note Recognition", type: "note", target: 12 },
      { icon: "theory", label: "Begin Theory Level 1", type: "theory", level: 1, mode: "begin" },
      { icon: "piece",  label: "Learn your first Absolute Beginner piece", type: "piece", tier: 0, count: 1 }
    ],
    [ // 2 Beginner
      { icon: "days",   label: "Reach 100 days of practice", type: "days", target: 100 },
      { icon: "scales", label: "C, G, D and F major with tonic triads and arpeggios", type: "self", key: "s2-scales" },
      { icon: "note",   label: "Reach 30 in Note Recognition", type: "note", target: 30 },
      { icon: "chord",  label: "Reach 10 in Chord Recognition", type: "chord", target: 10 },
      { icon: "ear",    label: "Reach 15 in the Ear Training tool", type: "ear", target: 15 },
      { icon: "theory", label: "Complete Theory Level 1", type: "theory", level: 1, mode: "complete" },
      { icon: "piece",  label: "Learn 4 Beginner pieces", type: "piece", tier: 1, count: 4 }
    ],
    [ // 3 Foundations
      { icon: "days",   label: "Reach 250 days of practice", type: "days", target: 250 },
      { icon: "scales", label: "A, B♭ and E♭ major; begin natural minors A, E, D", type: "self", key: "s3-scales" },
      { icon: "note",   label: "Reach 40 in Note Recognition", type: "note", target: 40 },
      { icon: "chord",  label: "Reach 16 in Chord Recognition", type: "chord", target: 16 },
      { icon: "ear",    label: "Reach 24 in the Ear Training tool", type: "ear", target: 24 },
      { icon: "theory", label: "Complete Theory Level 2", type: "theory", level: 2, mode: "complete" },
      { icon: "piece",  label: "Learn 1 to 2 Lower Intermediate pieces", type: "piece", tier: 2, count: 2 },
      { icon: "sightread", label: "Sight-read a new easy piece weekly, read once", type: "self", key: "s3-sr" }
    ],
    [ // 4 Intermediate
      { icon: "scales", label: "Majors plus natural and harmonic minors secure", type: "self", key: "s4-scales" },
      { icon: "note",   label: "Reach 46 in Note Recognition", type: "note", target: 46 },
      { icon: "chord",  label: "Reach 22 in Chord Recognition", type: "chord", target: 22 },
      { icon: "ear",    label: "Reach 30 in the Ear Training tool", type: "ear", target: 30 },
      { icon: "piece",  label: "Learn 2 to 3 Lower Intermediate pieces", type: "piece", tier: 2, count: 3 }
    ],
    [ // 5 Confident
      { icon: "scales", label: "Scales, minors and arpeggios across more keys, faster", type: "self", key: "s5-scales" },
      { icon: "note",   label: "Hold Note Recognition near the ceiling", type: "note", target: 48 },
      { icon: "ear",    label: "Hold the Ear Training tool near the ceiling", type: "ear", target: 30 },
      { icon: "chord",  label: "Hold Chord Recognition near the ceiling", type: "chord", target: 24 },
      { icon: "piece",  label: "Learn 1 Upper Intermediate piece", type: "piece", tier: 3, count: 1 }
    ],
    [ // 6 Advanced
      { icon: "scales", label: "Scales and arpeggios fluent in all keys", type: "self", key: "s6-scales" },
      { icon: "piece",  label: "Learn 1 Advanced piece", type: "piece", tier: 4, count: 1 }
    ],
    [ // 7 Performer
      { icon: "perform", label: "Prepare and perform a balanced Advanced programme", type: "self", key: "s7-prog" },
      { icon: "piece",   label: "Begin reaching into Expert repertoire", type: "piece", tier: 5, count: 1 }
    ],
    [ // 8 Artist
      { icon: "expert", label: "Learn an Expert work and make it your own", type: "self", key: "s8-expert" }
    ]
  ];
