...
(function () {
  ...
  const T = {
    ...
    repertoire: {
      ...
      focus: [
        "Choose very easy pieces you enjoy and play them right through, even slowly. When you hit a wrong note or a stumble, stop, find the exact spot, and repeat just that bar until it is comfortable. Getting used to finishing a piece, and fixing the small things along the way, is the whole job at this stage.",
        "Build a habit of learning a new easy piece every week or two. Practise hands separately when needed, identify which bar is causing trouble and isolate it, then combine slowly. Begin adding simple dynamics so each piece carries a little expression rather than being just the right notes in time.",
    ...
    technique: {
      ...
      canDo: [
        "You can play five finger patterns and simple scales, and your hands are learning to move evenly and stay relaxed. You are starting to feel the difference between a tense hand and a free one.",
        "You can play major scales and basic arpeggios in common keys, hands separately and beginning to combine them. You can tell when your playing is uneven or rushed.",
        "You can play scales and arpeggios in more keys with steadier evenness and control, and your hands are becoming independent. You are noticing the same technical problems, such as uneven fingers or awkward turns, recurring across different exercises.",
      ...
      focus: [
        "Keep technique gentle and regular. Focus on a relaxed hand, curved fingers and an even sound, and notice when tension creeps in so you can release it. A few minutes of careful five finger work and simple scales each day builds the foundation everything else rests on.",
        ...
        "Keep your technique in peak condition with focused maintenance, and prepare the specific challenges of recital repertoire well ahead of performance. Ensure your technical choices support idiomatic, stylish playing, and rely on your refined practice strategies to stay efficient.",
    ...
    sight_reading: {
      ...
      focus: [
        ...
        "Keep going without stopping, even over small mistakes, as fluency matters more than perfection when reading. Look ahead of where you are playing, scan a new piece first for its key, time signature and obvious patterns, and use that understanding to read more confidently.",
        ...
        "Stretch to slightly harder material and keep reading new pieces often. Train your eyes to look further ahead, and lean on your understanding of harmony and structure to predict what comes next, which is the real engine of fluent reading.",
    ...
    musicianship: {
      ...
      canDo: [
        ...
        "You understand theory to around Grade 5 standard, recognise common chords and progressions, and are starting to improvise simple ideas. You can use this understanding to make real musical decisions in your playing.",
