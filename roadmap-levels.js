...
(function () {
  ...
  const T = {
    total: {
      ...
      canDo: [
        ...
        "You play with real expression and control, and harder repertoire is genuinely within reach. Your technique supports your musical ideas rather than holding them back, so you can manage faster passages, larger leaps and more complex textures. You understand the music well enough to interpret with a clear sense of style and shape, and you recognise familiar patterns and problems quickly, so you waste far less time working out how to practice something. In the library, you can expect to be comfortable with Upper Intermediate pieces.",
    ...
    sight_reading: {
      ...
      focus: [
        ...
        "Read demanding repertoire and accompaniments regularly to keep the skill sharp, and practice reading under realistic conditions such as accompanying or playing with others.",
  ...
  const EXTRAS = [
    { // 1 First Steps
      scales: [ { group: "scales", type: "self", key: "x1-scales-1", keys: ["D"], label: "D major scale, hands together, two octaves" },
                { group: "scales", type: "self", key: "x1-scales-2", keys: ["F"], label: "F major scale, hands together, two octaves" },
                { group: "scales", type: "self", key: "x1-scales-3", keys: ["A"], label: "A major scale, hands together, two octaves" },
                { group: "scales", type: "self", key: "x1-scales-4", keys: ["Bb"], label: "B♭ major scale, hands together, two octaves" },
                { group: "scales", type: "self", key: "x1-scales-5", keys: ["Eb"], label: "E♭ major scale, hands together, two octaves" } ],
      note:   [ { group: "note", type: "note", target: 16, match: { keys: ["C", "G"] }, label: "Score 16 in Note Recognition in C and G (a high score in the key)" },
                { group: "note", type: "note", target: 10, match: { keys: ["D", "F"] }, label: "Score 10 in Note Recognition in D and F major" },
                { group: "note", type: "note", target: 12, match: { acc: true }, label: "A general score of 12 in Note Recognition (accidentals, no key signature)" } ],
      theory: [ { group: "theory", type: "theory", level: 1, mode: "complete", label: "Complete Theory Level 1" } ],
      sightread: [ { group: "sightread", type: "self", key: "x1-sr-1", label: "Sight-read to 750 minutes total, always reading new material" },
                   { group: "sightread", type: "self", key: "x1-sr-2", label: "Sight-read to 1,000 minutes total, always reading new material" } ],
      piece:  [ { group: "piece", type: "piece", tier: 0, count: 2, label: "Learn a second Absolute Beginner piece" },
                { group: "piece", type: "piece", tier: 0, count: 3, label: "Learn a third Absolute Beginner piece" },
    ...
    { // 2 Beginner
      ...
      scales: [ { group: "scales", type: "self", key: "x2-scales-1", keys: ["A"], label: "A major scale, hands together, two octaves" },
                ...
                { group: "scales", type: "self", key: "x2-scales-4", keys: ["E"], label: "E major scale, hands together, two octaves" },
                { group: "scales", type: "self", key: "x2-scales-5", keys: ["Ab"], label: "A♭ major scale, hands together, two octaves" } ],
      arps:   [ { group: "arps", type: "self", key: "x2-arps-1", keys: ["A"], label: "A major arpeggio" },
                { group: "arps", type: "self", key: "x2-arps-2", keys: ["Bb"], label: "B♭ major arpeggio" },
                { group: "arps", type: "self", key: "x2-arps-3", keys: ["Eb"], label: "E♭ major arpeggio" } ],
      note:   [ { group: "note", type: "note", target: 25, match: { keys: ["C", "G", "D", "F"] }, label: "Score 25 in Note Recognition in each of C, G, D and F (a high score in the key)" },
                { group: "note", type: "note", target: 18, match: { keys: ["A", "E"] }, label: "Score 18 in Note Recognition in A and E major" },
                { group: "note", type: "note", target: 26, match: { acc: true }, label: "A general score of 26 in Note Recognition (accidentals)" } ],
      chord:  [ { group: "chord", type: "chord", target: 10, match: { keys: ["A", "E"], tier: 1 }, label: "Score 10 in Chord Recognition in A and E (triads in the key)" },
                { group: "chord", type: "chord", target: 10, match: { keys: ["Bb", "Eb"], tier: 1 }, label: "Score 10 in Chord Recognition in B♭ and E♭ (triads in the key)" },
                { group: "chord", type: "chord", target: 7, match: { tier: 1, mode: "free" }, label: "Score 7 in Chord Recognition (triads, any key, no key to lean on)" } ],
      ear:    [ { group: "ear", type: "ear", target: 12, match: { set: "major_minor" }, label: "Score 12 in the Ear Training tool (major versus minor, any key)" },
                { group: "ear", type: "ear", target: 15, match: { set: "major_minor" }, label: "Score 15 in the Ear Training tool (major versus minor)" },
                { group: "ear", type: "ear", target: 12, match: { set: "triads" }, label: "Score 12 in the Ear Training tool (triads)" } ],
      improv: [ { group: "improv", type: "self", key: "x2-improv-1", label: "Improvise using a broken-chord pattern in the left hand" },
                { group: "improv", type: "self", key: "x2-improv-2", label: "Improvise adding chord notes into your right-hand melody" },
                { group: "improv", type: "self", key: "x2-improv-3", label: "Improvise using 7th chords" } ],
      sightread: [ { group: "sightread", type: "self", key: "x2-sr-1", label: "Sight-read to 1,500 minutes total, reading new material" },
                   { group: "sightread", type: "self", key: "x2-sr-2", label: "Sight-read to 2,000 minutes total, reading new material" } ],
      piece:  [ { group: "piece", type: "piece", tier: 1, count: 5, label: "Learn a fifth Beginner piece" },
                { group: "piece", type: "piece", tier: 1, count: 6, label: "Learn a sixth Beginner piece" },
    ...
    { // 3 Foundations
      ...
      scales: [ { group: "scales", type: "self", key: "x3-scales-1", keys: ["E"], label: "E major scale, hands together, two octaves" },
                ...
                { group: "scales", type: "self", key: "x3-scales-4", keys: ["Db"], label: "D♭ major scale, hands together, two octaves" },
                { group: "scales", type: "self", key: "x3-scales-5", keys: ["Gb"], label: "G♭ major scale, hands together, two octaves (all 12 major keys complete)" } ],
      arps:   [ { group: "arps", type: "self", key: "x3-arps-1", keys: ["E"], label: "E major arpeggio" },
                { group: "arps", type: "self", key: "x3-arps-2", keys: ["Ab"], label: "A♭ major arpeggio" },
                { group: "arps", type: "self", key: "x3-arps-3", keys: ["B"], label: "B major arpeggio" },
                { group: "arps", type: "self", key: "x3-arps-4", keys: ["Db"], label: "D♭ major arpeggio" },
                { group: "arps", type: "self", key: "x3-arps-5", keys: ["Gb"], label: "G♭ major arpeggio" } ],
      minors: [ { group: "minors", type: "self", key: "x3-minors-1", keys: ["B"], label: "Natural, harmonic and melodic minor scales in B" },
                { group: "minors", type: "self", key: "x3-minors-2", keys: ["G"], label: "Natural, harmonic and melodic minor scales in G" },
                { group: "minors", type: "self", key: "x3-minors-3", keys: ["C"], label: "Natural, harmonic and melodic minor scales in C" } ],
      note:   [ { group: "note", type: "note", target: 18, match: { keys: ["E", "Ab", "B", "Db", "Gb"] }, label: "Score 18 in Note Recognition in the remaining keys (E, A♭, B, D♭, G♭)" },
                { group: "note", type: "note", target: 28, match: { keys: ["A", "Bb", "Eb"] }, label: "Score 28 in Note Recognition in each of A, B♭ and E♭ (a high score in the key)" },
                { group: "note", type: "note", target: 34, match: { clef: "mixed", acc: true }, label: "A general score of 34 in Note Recognition (mixed clef, accidentals)" },
                { group: "note", type: "note", target: 18, match: { clef: "mixed", range: "ledger" }, label: "Score 18 in Note Recognition on the ledger lines (mixed clef)" },
                { group: "note", type: "note", target: 16, match: { clef: "bass" }, label: "Score 16 in Note Recognition reading the bass clef" } ],
      chord:  [ { group: "chord", type: "chord", target: 10, match: { keys: ["A", "Bb", "Eb"], tier: 1 }, label: "Score 10 in Chord Recognition in A, B♭ and E♭ (triads in the key)" },
                { group: "chord", type: "chord", target: 10, match: { keys: ["E", "Ab", "B", "Db", "Gb"], tier: 1 }, label: "Score 10 in Chord Recognition in the remaining keys (triads in the key)" },
                { group: "chord", type: "chord", target: 8, match: { tier: 1, mode: "free" }, label: "Score 8 in Chord Recognition (triads, any key, no key to lean on)" },
                { group: "chord", type: "chord", target: 9, match: { tier: 2, mode: "free" }, label: "Score 9 in Chord Recognition (triads and inversions, any key)" } ],
      ear:    [ { group: "ear", type: "ear", target: 10, match: { set: "sevenths" }, label: "Score 10 in the Ear Training tool (sevenths)" },
                { group: "ear", type: "ear", target: 12, match: { set: "sevenths" }, label: "Score 12 in the Ear Training tool (sevenths)" } ],
      sightread: [ { group: "sightread", type: "self", key: "x3-sr-1", label: "Sight-read to 3,000 minutes total, reading new material" },
                   { group: "sightread", type: "self", key: "x3-sr-2", label: "Sight-read to 3,500 minutes total, at your playing standard" } ],
      piece:  [ { group: "piece", type: "piece", tier: 2, count: 3, label: "Learn a third Lower Intermediate piece" },
                { group: "piece", type: "piece", tier: 2, count: 4, label: "Learn a fourth Lower Intermediate piece" },
    ...
    { // 4 Intermediate
      interval: [ { group: "interval", type: "interval", target: 28, match: { side: "reading", tier: "pm", key_mode: "free" }, label: "Score 28 in Interval Training, reading perfect and major intervals, between any two notes" },
                  ...
                  { group: "interval", type: "interval", target: 12, match: { side: "listening", tier: "number", play: "melodic" }, label: "Score 12 in Interval Training, hearing intervals one after the other (melodic)" } ],
      ...
      arps:   [ { group: "arps", type: "self", key: "x4-arps-1", label: "All minor arpeggios (same key order as the majors)" },
                { group: "arps", type: "self", key: "x4-arps-2", label: "Dominant 7th arpeggios in the common keys" } ],
      minors: [ { group: "minors", type: "self", key: "x4-minors-1", keys: ["F#"], label: "Natural, harmonic and melodic minor scales in F♯" },
                { group: "minors", type: "self", key: "x4-minors-2", keys: ["C#"], label: "Natural, harmonic and melodic minor scales in C♯" },
                { group: "minors", type: "self", key: "x4-minors-3", keys: ["F"], label: "Natural, harmonic and melodic minor scales in F" },
                { group: "minors", type: "self", key: "x4-minors-4", keys: ["Bb"], label: "Natural, harmonic and melodic minor scales in B♭" },
                { group: "minors", type: "self", key: "x4-minors-5", keys: ["G#"], label: "Natural, harmonic and melodic minor scales in G♯" },
                { group: "minors", type: "self", key: "x4-minors-6", keys: ["Eb"], label: "Natural, harmonic and melodic minor scales in E♭ (all 12 minor keys complete)" } ],
      note:   [ { group: "note", type: "note", target: 36, match: { clef: "mixed", acc: true }, label: "Score 36 in Note Recognition (mixed clef, accidentals)" },
                { group: "note", type: "note", target: 38, match: { clef: "mixed", acc: true }, label: "Score 38 in Note Recognition (mixed clef, accidentals)" },
                { group: "note", type: "note", target: 40, match: { clef: "mixed", acc: true }, label: "Score 40 in Note Recognition (mixed clef, accidentals)" },
                { group: "note", type: "note", target: 26, match: { clef: "mixed", range: "ledger" }, label: "Score 26 in Note Recognition on the ledger lines (mixed clef)" } ],
      chord:  [ { group: "chord", type: "chord", target: 7, match: { tier: 3, mode: "free" }, label: "Score 7 in Chord Recognition (sevenths, any key)" },
                { group: "chord", type: "chord", target: 10, match: { tier: 3, mode: "free" }, label: "Score 10 in Chord Recognition (sevenths, any key)" } ],
      ear:    [ { group: "ear", type: "ear", target: 14, match: { set: "sevenths" }, label: "Score 14 in the Ear Training tool (sevenths)" },
                { group: "ear", type: "self", key: "x4-ear-prog", label: "Recognise a I–IV–V–I progression by ear" } ],
      improv: [ { group: "improv", type: "self", key: "x4-improv-1", label: "Improvise ending a phrase with a perfect cadence" },
                { group: "improv", type: "self", key: "x4-improv-2", label: "Improvise using a ii–V–I in a chosen key" },
                { group: "improv", type: "self", key: "x4-improv-3", label: "Improvise using imperfect and interrupted cadences" },
                { group: "improv", type: "self", key: "x4-improv-4", label: "Improvise freely over a chord backing" } ],
      sightread: [ { group: "sightread", type: "self", key: "x4-sr-1", label: "Sight-read to 5,000 minutes total, reading new material" },
                   { group: "sightread", type: "self", key: "x4-sr-2", label: "Sight-read to 6,000 minutes total, reading new material" } ],
      piece:  [ { group: "piece", type: "piece", tier: 2, count: 6, label: "Learn a sixth intermediate piece" },
                { group: "piece", type: "piece", tier: 3, count: 1, label: "Learn an Upper Intermediate piece" },
    ...
    { // 5 Confident
      ...
      scales: [ { group: "scales", type: "self", key: "x5-scales-1", label: "All scales in sixteenth notes at ♩=100, hands together" },
                ...
                { group: "scales", type: "self", key: "x5-scales-4", label: "Chromatic and whole-tone scales" } ],
      arps:   [ { group: "arps", type: "self", key: "x5-arps-1", label: "Dominant 7th arpeggios in all keys" },
                { group: "arps", type: "self", key: "x5-arps-2", label: "Diminished 7th arpeggios in all keys" } ],
      note:   [ { group: "note", type: "note", target: 44, match: { clef: "mixed", acc: true }, label: "Score 44 in Note Recognition (mixed clef, accidentals)" },
                { group: "note", type: "note", target: 48, match: { clef: "mixed", acc: true }, label: "Score 48 in Note Recognition (mixed clef, accidentals)" },
                { group: "note", type: "note", target: 34, match: { clef: "mixed", range: "ledger" }, label: "Score 34 in Note Recognition on the ledger lines (mixed clef)" },
                { group: "note", type: "note", target: 40, match: { clef: "mixed", range: "full" }, label: "Score 40 in Note Recognition across the full range (mixed clef)" },
                { group: "note", type: "self", key: "x5-note-speed", label: "Read a short passage at sight-reading speed without stopping" } ],
      chord:  [ { group: "chord", type: "chord", target: 10, match: { tier: 3, mode: "free" }, label: "Score 10 in Chord Recognition (sevenths, any key)" },
                { group: "chord", type: "chord", target: 8, match: { tier: 4, mode: "free" }, label: "Score 8 in Chord Recognition (sevenths and inversions, any key)" } ],
      ear:    [ { group: "ear", type: "ear", target: 16, match: { set: "sevenths" }, label: "Score 16 in the Ear Training tool (sevenths)" },
                { group: "ear", type: "ear", target: 8, match: { set: "triads", answer_type: "exact" }, label: "Score 8 in the Ear Training tool naming the exact triad, not just its quality" },
                { group: "ear", type: "self", key: "x5-ear-1", label: "Recognise common progressions by ear (I–IV–V–I and ii–V–I)" },
                { group: "ear", type: "self", key: "x5-ear-2", label: "Tell perfect, imperfect and interrupted cadences apart by ear" } ],
      sightread: [ { group: "sightread", type: "self", key: "x5-sr-1", label: "Sight-read to 6,500 minutes total, reading new material" },
                   { group: "sightread", type: "self", key: "x5-sr-2", label: "Sight-read to 8,000 minutes total, reading new material" } ],
      piece:  [ { group: "piece", type: "piece", tier: 3, count: 7, label: "Learn a seventh Upper Intermediate piece" },
                { group: "piece", type: "piece", tier: 3, count: 8, label: "Learn an eighth Upper Intermediate piece" },
                { group: "piece", type: "piece", tier: 4, count: 1, label: "Learn an Advanced piece" },
    ...
    { // 6 Advanced
      ...
      chord:  [ { group: "chord", type: "chord", target: 8, match: { tier: 5, mode: "free" }, label: "Score 8 in Chord Recognition (seventh chords with inversions, any key)" },
                { group: "chord", type: "chord", target: 7, match: { tier: 6, mode: "free" }, label: "Score 7 in Chord Recognition (seventh chords in spread voicing, any key)" } ],
      ear:    [ { group: "ear", type: "ear", target: 10, match: { set: "extensions" }, label: "Score 10 in the Ear Training tool (extended chords: 9ths, 11ths and 13ths)" } ],
      scales: [ { group: "scales", type: "self", key: "x6-scales-1", label: "Chromatic scales, hands together" },
                ...
                { group: "scales", type: "self", key: "x6-scales-4", label: "Scales in thirds (easier keys)" },
                { group: "scales", type: "self", key: "x6-scales-5", label: "Scales in octaves, hands together" },
                { group: "scales", type: "self", key: "x6-scales-6", label: "Scales a tenth apart" },
      ...
      sightread: [ { group: "sightread", type: "self", key: "x6-sr-1", label: "Sight-read to 10,000 minutes total, reading new material" },
                   ...
                   { group: "sightread", type: "self", key: "x6-sr-3", label: "Sight-read to 15,000 minutes total, including accompaniment reading" } ],
      piece:  [ { group: "piece", type: "piece", tier: 4, count: 7, label: "Learn a seventh Advanced piece" },
                { group: "piece", type: "piece", tier: 4, count: 8, label: "Learn an eighth Advanced piece" },
                { group: "piece", type: "piece", tier: 5, count: 1, label: "Try an Expert piece" },
                { group: "piece", type: "piece", tier: 5, count: 2, label: "Learn a second Expert piece" },
                { group: "piece", type: "self", key: "x6-piece-mem", label: "Play an Advanced piece from memory" } ]
    },
    { // 7 Performer
      ...
      piece:  [ { group: "piece", type: "piece", tier: 5, count: 1, label: "Learn a first Expert piece" },
                { group: "piece", type: "piece", tier: 5, count: 2, label: "Learn a second Expert piece" },
                { group: "piece", type: "piece", tier: 5, count: 3, label: "Learn a third Expert piece" },
                { group: "piece", type: "self", key: "x7-piece-set", label: "Prepare a full contrasting recital set" } ]
    },
    { // 8 Artist
      ...
      piece:  [ { group: "piece", type: "self", key: "x8-piece-1", label: "Take on a second Expert work" },
                ...
                { group: "piece", type: "self", key: "x8-piece-3", label: "Arrange a piece" } ]
    }
  ];
