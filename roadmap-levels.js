  ...
  const EXTRAS = [
    ...
    { // 3 Foundations
      ...
      note:   [ { group: "note", type: "note", target: 18, match: { keys: ["E", "Ab", "B", "Db", "Gb"] }, label: "Score 18 in Note Recognition in the remaining keys (E, A♭, B, D♭, G♭)" },
                { group: "note", type: "note", target: 28, match: { keys: ["A", "Bb", "Eb"] }, label: "Score 28 in each of A, B♭ and E♭ (a high score in the key)" },
    ...
    { // 4 Intermediate
      scales: [ { group: "scales", type: "self", key: "x4-scales-1", label: "All 12 major scales in sixteenth notes (semiquavers) at ♩=88, hands together" },
                { group: "scales", type: "self", key: "x4-scales-2", label: "Major scales in contrary motion from C, two octaves" } ],
      ...
      ear:    [ { group: "ear", type: "ear", target: 14, match: { set: "sevenths" }, label: "Score 14 in the Ear Training tool (sevenths)" },
                { group: "ear", type: "self", key: "x4-ear-prog", label: "Recognise simple chord progressions by ear" } ],
    ...
    { // 5 Confident
      ...
      ear:    [ { group: "ear", type: "ear", target: 16, match: { set: "sevenths" }, label: "Score 16 in the Ear Training tool (sevenths)" },
                { group: "ear", type: "self", key: "x5-ear-1", label: "Recognise short chord progressions by ear" },
                { group: "ear", type: "self", key: "x5-ear-2", label: "Recognise cadences by ear" } ],
    ...
    { // 6 Advanced
      scales: [ { group: "scales", type: "self", key: "x6-scales-1", label: "Chromatic scales, hands together" },
                ...
                { group: "scales", type: "self", key: "x6-scales-4", label: "Scales in double thirds (easier keys)" },
