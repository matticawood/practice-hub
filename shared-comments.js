...
/* Negative margin cancels the 36px indent of the surrounding .tc-comment-replies
   so the composer spans the full width like the top-level comment form. */
.tc-reply-composer { padding:13px 20px; margin-left:-36px; }
